...
<header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="formulario.php">Registrar plato</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="productosbodega.php">platos guardados</a>
                  </li>
                </ul>
    ...
    <main>
        <h4 class="text-center mt-5">PLATOS GUARDADOS</h4>
        <br>
          ...
          <div class="row">
            ...
            ?>
              <div class="col-md-3">
                  ...
                  <div class="card-body">
                    <h4 class="card-title text-center"><?php echo $value['nombrePlato'];?></h4>
                    <p class="card-text text-center"><?php echo $value['DescripcionPlato'];?></p>
                    <p class="card-text text-center"><?php echo '$ '.number_format($value['precioPlato']);?></p>
